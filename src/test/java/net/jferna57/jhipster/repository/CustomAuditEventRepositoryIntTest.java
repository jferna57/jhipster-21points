package net.jferna57.jhipster.repository;

import net.jferna57.jhipster.TwentyOnePointsApp;
import net.jferna57.jhipster.config.Constants;
import net.jferna57.jhipster.config.audit.AuditEventConverter;
import net.jferna57.jhipster.domain.PersistentAuditEvent;
...
import static net.jferna57.jhipster.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
